...
type SkuReadyStockTemp struct{}

// BuildQuery implements [batch_compute.Table].
func (s SkuReadyStockTemp) BuildQuery(graph *batch_compute.GraphContext) string {
...
func (s SkuReadyStockTemp) TableName() string {
	return "sku_ready_stock_temp"
}

// Temporary implements [batch_compute.Table].
func (s SkuReadyStockTemp) Temporary() bool {
	return true
}
